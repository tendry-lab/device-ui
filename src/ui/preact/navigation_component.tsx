...
> {
  constructor(props: NavigationComponentProps) {
    ...
    this.otaState = new StateMonitor<boolean>(false);
  }
  ...
  render() {
    return (
      <>
        ...
        <UpdateComponent stateMonitor={this.otaState} />
      </>
    );
  }
  ...
  private handleUpdate = () => {
    this.otaState.set(true);
  };

  private helpState: StateMonitor<boolean>;
  private otaState: StateMonitor<boolean>;
}
